...
def read_only():
	def innfn(fn):
		def wrapper_fn(*args, **kwargs):
			...
			my_array = ["027817","hassaan.khalid@gourmetpakistan.com","000001","zulqarnain","zulqarnain@gourmetpakistan.com","shaharyar@gourmetpakistan.com","zubair@gourmetpakistan.com","muhammadyasir@gourmetpakistan.com","abdul.samad@gourmetpakistan.com","shoaib.rehmat@gourmetpakistan.com","waqas.malik@gourmetpakistan.com"]
...
def get_print(doctype=None, name=None, print_format=None, style=None, html=None, as_pdf=False, doc=None, output = None, no_letterhead = 0, password=None, filters=None):
	...
	local.form_dict.custom_filters = filters
