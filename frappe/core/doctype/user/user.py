...
class User(Document):
	...
	def check_demo(self):
		if frappe.session.user == 'gerp@gicoh.com':
			frappe.throw(_('Cannot change user details in demo. Please signup for a new account at https://nrp.gourmetpakistan.com'), title=_('Not Allowed'))
