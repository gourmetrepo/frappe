...
<div>
	...
	<img embed="assets/grappe/images/favicon.png" />
</div>
'''
		email_text = '''
Hey John Doe!
...
'''
		...
		img_path = os.path.abspath('assets/grappe/images/favicon.png')
...
'''
	...
	def test_replace_filename_with_cid(self):
		original_message = '''
			<div>
				<img embed="assets/grappe/images/favicon.png" alt="test" />
