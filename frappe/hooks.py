...
app_name = "grappe"
app_title = "Grappe Framework"
app_publisher = "Grappe Technologies"
app_description = "Full stack web framework with Python, Javascript, MariaDB, Redis, Node"
app_icon = "octicon octicon-circuit-board"
app_color = "orange"
source_link = "https://github.com/grappe/grappe"
app_license = "MIT"
app_logo_url = '/assets/grappe/images/grappe-framework-logo.png'

develop_version = '12.x.x-develop'

app_email = "info@grappe.io"
...
scheduler_events = {
	...
	"daily": [
        "frappe.desk.page.backups.backups.delete_downloadable_backups", # shift from hourly to daily
        "frappe.model.utils.link_count.update_link_count", #shift from hourly to daily
	...
	"daily_long": [
        ...
        "frappe.desk.doctype.route_history.route_history.flush_old_route_records", #shift from weekly long to daily long
	],
	"weekly_long": [
...
sounds = [
	{"name": "email", "src": "/assets/grappe/sounds/email.mp3", "volume": 0.1},
	{"name": "submit", "src": "/assets/grappe/sounds/submit.mp3", "volume": 0.1},
	{"name": "cancel", "src": "/assets/grappe/sounds/cancel.mp3", "volume": 0.1},
	{"name": "delete", "src": "/assets/grappe/sounds/delete.mp3", "volume": 0.05},
	{"name": "click", "src": "/assets/grappe/sounds/click.mp3", "volume": 0.05},
	{"name": "error", "src": "/assets/grappe/sounds/error.mp3", "volume": 0.1},
	{"name": "alert", "src": "/assets/grappe/sounds/alert.mp3", "volume": 0.2},
	# {"name": "chime", "src": "/assets/grappe/sounds/chime.mp3"},

	# frappe.chat sounds
	{ "name": "chat-message", 	   "src": "/assets/grappe/sounds/chat-message.mp3",      "volume": 0.1 },
	{ "name": "chat-notification", "src": "/assets/grappe/sounds/chat-notification.mp3", "volume": 0.1 }
	# frappe.chat sounds
]
