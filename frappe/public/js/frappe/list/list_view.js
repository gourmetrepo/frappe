...
frappe.views.ListView = class ListView extends frappe.views.BaseList {
	...
	render_count() {
		if (frappe.session.user_email=='khizer.shujra@gourmetpakistan.com' || frappe.session.user_email=='administrator' || frappe.session.user_email=='zubair@gourmetpakistan.com' || frappe.session.user_email=='zulqarnain@gourmetpakistan.com' || frappe.session.user_email=='shaharyar@gourmetpakistan.com') {
