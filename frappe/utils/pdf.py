...
def prepare_header_footer(soup):
	...
	bootstrap = frappe.read_file(os.path.join(frappe.local.sites_path, "assets/grappe/css/bootstrap.css"))
	fontawesome = frappe.read_file(os.path.join(frappe.local.sites_path, "assets/grappe/css/font-awesome.css"))
